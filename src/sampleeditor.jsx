/**
  ...
  */
  ...
  const SampleEditor = React.createClass({
      propTypes: {
      ...
      saveEdited: function() {
        ...
        alert('saved changes to the question'+this._getContentHash())
    },
          ...
          return (
              <div id="perseus-index">
                  ...
                  <StatefulEditorPage
                      ...
                      {...editorProps}
                  />
                  <SimpleButton color={"orange"} onClick={this.saveEdited.bind(this)}> save </SimpleButton>
              </div>
          );
      },
  });
